...
// Poll all Mikrotik servers and store metrics
...
async function pollOne(server) {
    ...
    // GET /rest/interface — find ether1 or first active interface
...
// Convert RouterOS uptime string "1d2h3m4s" → seconds
